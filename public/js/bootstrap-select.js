    ...
    createLi: function() {
      ...
      this.$element.find('option').each(function(index) {
        ...
        if ($this.data('thumbnail')) {
          ...
          text =
            '<span class="media">' +
              '<span class="media-left"><img style="'+ $this.data('css')+'" src="' + $this.data('thumbnail') + '" class="media-object" onerror="src=\'data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7\'"></span>' +
